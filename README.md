        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <p>Buy Fancy items and Cosmetics online for Women from <span style="background-color:lime">Sans Fancy Milkyway</span>
...
<html lang="en">
    <head>
        ...
        .ceoph{
            background-image: url(/static/images/po.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
        ...
        .manph1{
            background-image: url(/static/images/niv.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph1{
            background-image: url(/static/images/dar.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph2{
            background-image: url(/static/images/nan.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph3{
            background-image: url(/static/images/Dora.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>Sanjai T</h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="center"><b><h2>Nivashi</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p><b><h2>B.surendhar</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>Dario</h2></b></p></div>
                    <div class="amph2"></div>
                    <div class="am2"><p align="center"><b><h2>Nandha</h2></b></p></div>
                    <div class="amph3"></div>
                    <div class="am3"><p align="center"><b><h2>Dhareene</h2></b></p></div><br>
